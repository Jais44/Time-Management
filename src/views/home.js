  ...
  return (
    <div className="home-container">
      ...
      <div className="home-header">
        ...
        >
          <span className="logo">STUDYTIME</span>
      ...
      <div className="home-hero">
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">Master Your Time</h1>
        ...
        <div className="featuresContainer">
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Discover how our tool can help you stay organized and
            ...
            <div className="home-container03">
              <FeatureCard
                heading="Task List"
                subHeading="Easily create and manage your daily tasks and assignments."
              ></FeatureCard>
              <FeatureCard
                heading="Time Tracker"
                subHeading="Track the time spent on each task to improve productivity and efficiency."
              ></FeatureCard>
              <FeatureCard
                heading="Priority Setting"
                subHeading="Set priorities for tasks to focus on what's most important first."
              ></FeatureCard>
              <FeatureCard
                heading="Deadline Reminders"
                subHeading="Receive notifications for upcoming deadlines to stay on top of your schedule."
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <h2 className="heading2">
              Choose the Right Plan for Your Time Management Needs
            </h2>
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Unlock powerful features to take control of your time and
                  achieve more
                </span>
              </span>
            </span>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                ...
                <div className="home-container12">
                  ...
                  <span className="bodySmall">Progress tracking</span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">Priority task setting</span>
                </div>
                <div className="home-container18">
                  <span className="home-text52">✔</span>
                  <span className="bodySmall">Customizable categories</span>
                </div>
                ...
                <div className="home-container20">
                  ...
                  <span className="bodySmall">Detailed analytics</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Maximize your productivity with premium time management
                  features
                </span>
              </div>
              ...
              <div className="home-container23">
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">Time blocking capabilities</span>
                </div>
                <div className="home-container26">
                  <span className="home-text65">✔</span>
                  <span className="bodySmall">Team collaboration tools</span>
                </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Efficient Time Management for Student Success
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our Time Management Tool is designed to help students
                  effectively organize their schedules, prioritize tasks, and
                  achieve academic excellence. With features such as task lists,
                  reminders, and progress tracking, you can stay on top of your
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Our time management tool helps students prioritize tasks, set deadlines, and track progress to ensure efficient use of time."
              ...
              ></Question1>
              <Question1
                answer="Yes, our time management tool is accessible on various devices including smartphones, tablets, and computers for convenience."
                question="Can I access this tool on multiple devices?"
              ></Question1>
              <Question1
              ...
              ></Question1>
              <Question1
                answer="Yes, our time management tool allows users to sync their tasks and schedules with popular calendar apps for seamless integration."
                question="Can I sync my tasks and schedules with other calendar apps?"
              ></Question1>
            </div>
          </div>
        </div>
